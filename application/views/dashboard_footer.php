<div data-role="footer" data-position="fixed" data-tap-toggle="false" class="ui-state-persistent" style="text-align:center;">
	<a href="#p_book" class="<?php echo ($page == "p_book") ? "ui-btn-active" : ""; ?>">My Book</a>
	<a href="#p_feed" class="<?php echo ($page == "p_feed") ? "ui-btn-active" : ""; ?>">Feed</a>
