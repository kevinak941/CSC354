<script type="text/javascript">
	function p_object-create($scope) {
		$scope.inputs	=	[
...
<div data-role="page" id="p_object-create" ng-controller="p_object-create">
	...
	<div data-role="content">
		...
		<input type="text" id="object_create_name" name="object_create_name" />
		<label for="object_create_tags">Tags</label>
		<input type="text" id="object_create_tags" name="object_create_tags" />
