...
<div data-role="page" id="p_register">
	...
	<div data-role="content">
		...
		<input type="password" id="register_password_confirm" name="register_password_confirm" />
		</form>
		<a id="register_create" data-role="button">Create</a>
	</div>
